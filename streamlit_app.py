...
Correção v2.1:
  [FIX-2] authenticate_user agora retorna dict serializado (não objeto ORM).
          Removida a montagem manual do dict aqui — evita DetachedInstanceError.
"""
...
<div style="text-align:center; margin-bottom:2rem;">
  ...
  <p style="color:#6b7280; font-size:0.85rem;">Sistema de Cálculo IEC 60909 · v2.1</p>
</div>
        ...
        if not username or not password:
            ...
            with st.spinner("Autenticando..."):
                try:
                    ...
                    # [FIX-2] authenticate_user retorna dict ou None —
                    # nunca mais um objeto ORM detached
            ...
            if user_dict:
                # [FIX-2] Atribuição direta — sem acessar atributos ORM
